...
st.set_option('deprecation.showPyplotGlobalUse', False) # To ignore warnings

st.title("Sentiment Analysis of Tweets about US Airlines") # Main Title
st.sidebar.title("Sentiment Analysis of Tweets") # Sidebar Title
st.markdown("Welcome to the Streamlit dashboard used "
            "to analyze sentiments of tweets 🐦")
st.sidebar.markdown("This application is a Streamlit dashboard used "
            "to analyze sentiments of tweets 🐦")

@st.cache(persist=True) # To enable caching 
def load_data():
...
st.sidebar.header("Try Yourself")
st.sidebar.write('To enhance/add features to this Streamlit Web-App, tick the checkbox below to know how:', (''))
